require(['./config'],function(){
    require(['jquery','utils'],function($){
        require(['bootstrap','drop3'],function(){
            var the = $("div.ndp-drop3-wrapper[name=inline-drop]").drop3({
				allowInput:true,
            ...
            $("div.ndp-drop3-wrapper[name=tree-drop2]").drop3({
                data:[{text:"新疆",val:'xj'},
            ...
            $("div.ndp-drop3-wrapper[name=group-drop2]").drop3({
				type:3,
                data:[
